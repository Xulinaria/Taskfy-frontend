    ...
    <header className="flex justify-between items-center mx-[40px] mt-[40px]">
      ...
      <div className="flex">
        <div className="flex ml-[40px] bg-gradient-to-br from-[#ebf1f6] from-60% to-white rounded-[76px] p-[2px] mr-[40px] shadow-mainShadow">
          <div className="bg-[#F1F5F9] flex h-full items-center rounded-[76px]">
            <div className="p-[10px] bg-gradient-to-br from-[#C9D9E8] to-white mx-[20px] my-[10px] rounded-[25px]">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
            ...
            <div className="p-[10px] rounded-[25px] bg-mainBlue mr-[20px] my-[10px] shadow">
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
